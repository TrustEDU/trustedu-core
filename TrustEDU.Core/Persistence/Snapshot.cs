...
namespace TrustEDU.Core.Persistence
{
    public abstract class Snapshot : IDisposable, IPersistence, IScriptTable
    {
        ...
        public abstract CacheItem<UInt256, BlockState> Blocks { get; }
        public abstract CacheItem<UInt256, TransactionState> Transactions { get; }
        public abstract CacheItem<UInt160, AccountState> Accounts { get; }
        public abstract CacheItem<UInt256, UnspentCoinState> UnspentCoins { get; }
        public abstract CacheItem<UInt256, SpentCoinState> SpentCoins { get; }
        public abstract CacheItem<ECPoint, ValidatorState> Validators { get; }
        public abstract CacheItem<UInt256, AssetState> Assets { get; }
        public abstract CacheItem<UInt160, ContractState> Contracts { get; }
        public abstract CacheItem<StorageKey, StorageItem> Storages { get; }
        public abstract CacheItem<UInt32Wrapper, HeaderHashList> HeaderHashList { get; }
