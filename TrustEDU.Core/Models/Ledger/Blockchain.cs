...
namespace TrustEDU.Core.Models.Ledger
{
    public sealed class Blockchain : UntypedActor
    {
        ...
        public static readonly uint SecondsPerBlock = Configs.Default.SecondsPerBlock;
        ...
        public static readonly ECPoint[] StandbyValidators = Configs.Default.StandbyValidators.OfType<string>().Select(p => ECPoint.DecodePoint(p.HexToBytes(), ECCurve.Secp256r1)).ToArray();
