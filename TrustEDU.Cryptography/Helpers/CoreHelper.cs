...
namespace TrustEDU.Core.Base.Helpers
{
    public static class CoreHelper
    {
        ...
        internal static IEnumerable<TResult> WeightedFilter<T, TResult>(this IList<T> source, decimal start, decimal end, Func<T, long> weightSelector, Func<T, long, TResult> resultSelector)
        {
            ...
            decimal amount = source.Sum(weightSelector);
            long sum = 0;
            decimal current = 0;
            foreach (T item in source)
            {
